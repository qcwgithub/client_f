...
final sceneRoomMessageProvider =
    Provider.family<ClientChatMessage, (int, bool, int)>((ref, params) {
      final (int roomId, bool useClientId, int messageId) = params;
      SceneMessagesModel roomMessageListModel = ref.watch(
        sceneMessagesProvider(roomId),
      );

      int index = roomMessageListModel.findMessageIndex(
        useClientId,
        messageId,
        true,
      );
